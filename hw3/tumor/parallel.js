...
var max = 70;
  ...
  g.append("svg:g")
    ...
    .append("svg:text")
      ...
      .attr("y", function(d,i) { console.log(d+"__"+i);return i%2 == 0 ? -14 : -30 } )
      .attr("x", 0)
      .attr("class", "label")
      .text(String)
      .append("title")
  ...
  //add an axis for displaying box plot
  g.append("svg:g")
      .attr("class","boxAxis")
      .attr("transform","translate(0,0)")
      .each(function(d,i){
          ...
          d3.select(this)
              ...
              .attr("fill","black");*/
          //console.log("test1")
          processData(data,xscale,yscale,dimensions);
          //console.log("test2")
...
/*
* d: the therapy data
* ctx: the context, forground or background
* color: the color to be used to render
* */
function path(d, ctx, color) {
  if (color) ctx.strokeStyle = color;
  ctx.beginPath();
